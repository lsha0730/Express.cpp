...
// Default constructor
flash::Socket::Socket(int domain, int service, int protocol, int port, u_long interface)
{
...
// Getter functions
struct sockaddr_in flash::Socket::address()
{
    return address_;
}

int flash::Socket::sock()
{
    return sock_;
}

// Setter functions
void flash::Socket::set_connection(int con)
{
    connection_ = con;
}